...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        ...
        r_win_cve = Renseignement.objects.create(
            ...
            source="NVD",
            url_source="https://nvd.nist.gov/vuln/detail/CVE-2026-41823",
        ...
        r_win_bulletin = Renseignement.objects.create(
            ...
            url_source="https://msrc.microsoft.com/update-guide/",
            criticite="elevee",
            nature="vulnerabilite",
            taxonomie_editeur="Microsoft",
            taxonomie_produit="Windows 11",
        ...
        r_palo = Renseignement.objects.create(
            ...
            source="CERT-FR",
            url_source="https://www.cert.ssi.gouv.fr/avis/",
            criticite="elevee",
            nature="vulnerabilite",
        ...
        r_nis2 = Renseignement.objects.create(
            ...
            source="ANSSI",
            url_source="https://www.ssi.gouv.fr/",
            criticite="moyenne",
        ...
        r_iso = Renseignement.objects.create(
            ...
            source="ISO",
            url_source="https://www.iso.org/standard/27001",
            criticite="moyenne",
            nature="information",
        ...
        r_python = Renseignement.objects.create(
            ...
            source="python.org",
            url_source="https://www.python.org/downloads/release/python-3127/",
            criticite="moyenne",
            nature="correctif",
