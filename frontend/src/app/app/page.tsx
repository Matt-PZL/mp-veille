...
const LIBELLES_ETAPES: Record<string, { titre: string; lien: string; action: string }> = {
  ...
  referentiels: {
    ...
    lien: "/app/actifs?type=normatif",
    action: "Sélectionner",
  },
  traitement: {
    titre: "Traitez un renseignement",
    lien: "/app/renseignements",
    ...
    >
      ...
      <div className="monitoring-tuiles grid gap-3.5 lg:grid-cols-2">
        <div className="grid grid-cols-2 gap-2.5">
          <TuileSimple ton="neutre" icone={<IconServer />} label="Total Actifs" valeur={d.nb_actifs} href="/app/actifs" />
          <TuilePaire
            haut={{ ton: "faib", label: "Actifs clean", valeur: d.nb_actifs_clean, href: "/app/actifs?etat=clean" }}
            bas={{
              ton: "gold",
              label: "Actifs à risque",
              valeur: d.nb_actifs_avec_non_traites,
              href: "/app/actifs?etat=non_traite",
            }}
          />
          <TuileSimple
            ton="accent"
          ...
          <TuilePaire
            haut={{
              ...
              href: "/app/renseignements?statut=clos,non_applicable",
            }}
            bas={{
              ton: "gold",
              label: "Renseignements non traités",
              valeur: d.nb_ouverts,
              href: "/app/renseignements?statut=a_traiter,en_cours",
            }}
          />
        </div>
        ...
        <div className="grid grid-cols-2 gap-2.5">
          <TuileSimple
            ...
            href="/app/renseignements?criticite=critique&statut=a_traiter,en_cours"
          />
          <TuileSimple
            ton="elev"
            icone={<IconBars />}
            ...
            href="/app/renseignements?criticite=elevee&statut=a_traiter,en_cours"
          />
          <TuileSimple
            ton="moy"
            icone={<IconBars />}
            ...
            href="/app/renseignements?criticite=moyenne&statut=a_traiter,en_cours"
          />
          <TuileSimple
            ton="faib"
            icone={<IconBars />}
            ...
            href="/app/renseignements?criticite=faible&statut=a_traiter,en_cours"
          />
        </div>
      </div>
      ...
      <div className="grid gap-3.5 lg:grid-cols-12">
        <Card className="lg:col-span-7">
          <CardHead
            ...
            action={<Link href="/app/renseignements" className="hover:text-accent">Tout voir</Link>}
          />
            ...
            {d.echeances.length ? (
              d.echeances.map((e) => (
                <Link
                  ...
                  href={`/app/renseignements/${e.id_renseignement}`}
                  className="flex items-center gap-3 border-b border-border px-[18px] py-[11px] text-[13px] last:border-b-0 hover:bg-surface-2"
                >
